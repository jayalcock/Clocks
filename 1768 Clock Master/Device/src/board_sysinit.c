...
static const PINMUX_GRP_T pinmuxing[] = {
	...
	//{0,  26,  IOCON_MODE_INACT | IOCON_FUNC2},	/* DAC */
        ...
        {2,  1,   IOCON_MODE_PULLDOWN | IOCON_FUNC0},	/* Motor shaft 2 pulse */
        {2,  2,   IOCON_MODE_INACT | IOCON_FUNC0},	/* Motor shaft 2 direction */
        {2,  3,   IOCON_MODE_REPEATER | IOCON_FUNC0},	/* GPIO Stepper Driver Reset */
        {2,  4,   IOCON_MODE_PULLDOWN | IOCON_FUNC0},	/* Motor shaft 1 pulse */
        {2,  5,   IOCON_MODE_INACT | IOCON_FUNC0},	/* Motor shaft 1 direction */            
