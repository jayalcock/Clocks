...
static void gpio_init(void)
{
    ...
    // Set up GPIO - Clock 0   
    Chip_IOCON_PinMuxSet(LPC_IOCON, IOCON_PIO0_2, (IOCON_FUNC0 | IOCON_MODE_PULLDOWN)); 
    Chip_IOCON_PinMuxSet(LPC_IOCON, IOCON_PIO0_3, (IOCON_FUNC0 | IOCON_MODE_PULLDOWN)); 
    ...
    // Set up GPIO - Clock 1
    Chip_IOCON_PinMuxSet(LPC_IOCON, IOCON_PIO0_6, (IOCON_FUNC0 | IOCON_MODE_PULLDOWN)); 
    Chip_IOCON_PinMuxSet(LPC_IOCON, IOCON_PIO0_7, (IOCON_FUNC0 | IOCON_MODE_PULLDOWN)); 
    Chip_IOCON_PinMuxSet(LPC_IOCON, IOCON_PIO0_8, (IOCON_FUNC0 | IOCON_MODE_PULLDOWN)); 
    Chip_IOCON_PinMuxSet(LPC_IOCON, IOCON_PIO0_9, (IOCON_FUNC0 | IOCON_MODE_PULLDOWN)); 
    ...
    // Set up GPIO - Clock 2
    Chip_IOCON_PinMuxSet(LPC_IOCON, IOCON_PIO1_4, (IOCON_FUNC0 | IOCON_MODE_PULLDOWN)); 
    Chip_IOCON_PinMuxSet(LPC_IOCON, IOCON_PIO1_5, (IOCON_FUNC0 | IOCON_MODE_PULLDOWN)); 
    Chip_IOCON_PinMuxSet(LPC_IOCON, IOCON_PIO1_6, (IOCON_FUNC0 | IOCON_MODE_PULLDOWN)); 
    Chip_IOCON_PinMuxSet(LPC_IOCON, IOCON_PIO1_7, (IOCON_FUNC0 | IOCON_MODE_PULLDOWN)); 
    ...
    // Set up GPIO - Clock 3
    Chip_IOCON_PinMuxSet(LPC_IOCON, IOCON_PIO1_8,   (IOCON_FUNC0 | IOCON_MODE_PULLDOWN)); 
    Chip_IOCON_PinMuxSet(LPC_IOCON, IOCON_PIO1_10,  (IOCON_FUNC0 | IOCON_MODE_PULLDOWN)); 
    Chip_IOCON_PinMuxSet(LPC_IOCON, IOCON_PIO1_11,  (IOCON_FUNC0 | IOCON_MODE_PULLDOWN)); 
    Chip_IOCON_PinMuxSet(LPC_IOCON, IOCON_PIO2_0,   (IOCON_FUNC0 | IOCON_MODE_PULLDOWN)); 
    ...
    Chip_IOCON_PinMuxSet(LPC_IOCON, IOCON_PIO0_1, (IOCON_FUNC0 | IOCON_MODE_PULLUP)); // Pulldown per VID6606 datasheet 
